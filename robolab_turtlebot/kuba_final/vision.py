...
# HSV profile tuned for yellow garage wall.
GARAGE_MIN_H = 21
GARAGE_MAX_H = 60
GARAGE_MIN_S = 100
GARAGE_MAX_S = 255
...
# Area limits for the garage wall detection.
GARAGE_DEFAULT_MIN_AREA = 30000
GARAGE_DEFAULT_MAX_AREA = 300000

# Keep the shape filter permissive enough for a large wall-like object.
GARAGE_DEFAULT_AXIS_RATIO_MIN = 0.10
